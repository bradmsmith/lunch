...
$name = explode(' ', get_loggedin_user()->name);
...
echo '<li class="dropdown"><a href="/profile"><img src="' . get_loggedin_user()->getIconURL('small') . '" style="float: right; padding-left: 10px;"/>' . $name[0] . '<br/><span style="font-size: .8em;">' . $name[1] . '</span></a>';
